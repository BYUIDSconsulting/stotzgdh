...
vignette: >
  %\VignetteIndexEntry{Linear_Interpolation}
...
load("~/Projects/Stotz_Consulting_Class/stotzgdh/data/li_test.rda")
DT::datatable(li_test)
```
...
```{r}
load("~/Projects/Stotz_Consulting_Class/stotzgdh/data/interpolation_test_dataset.rda")

DT::datatable(interpolation_test_dataset)
```
